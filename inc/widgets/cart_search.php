    ...
    function widget($args, $instance) {
        ...
        <div class="widget_cart_search_wrap">
            <div class="header">
				...
				<?php endif; ?>
				<?php if($show_search):?>
				<a href="javascript:void(0)" class="icon_search_wrap" data-display=".widget_searchform_content" data-no_display=".shopping_cart_dropdown"><i class="fa fa-search search-icon"></i> <?php if ( $title ) echo $before_title . $title . $after_title;?></a>
				<?php endif; ?>
            </div>
			<?php if($woocommerce && $show_cart):?>
