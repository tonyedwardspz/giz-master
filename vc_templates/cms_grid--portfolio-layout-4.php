...
?>
<div class="cms-grid-wraper  cms-grid-portfolio-layout-4" id="<?php echo esc_attr($atts['html_id']);?>">
            ...
            <ul class="cms-filter-category">
                ...
                <?php
                    ...
                    <li><a href="#" data-group="<?php echo esc_attr('category-'.$category->slug);?>">
                            <?php echo __($category->name, CMS_NAME);?>
                        </a>
                    </li>
                ...
                <div class="cms-grid-item-wrap">
                    ...
                    <div class="cms-grid-item-meta">
                        ...
                        <div class="cms-grid-item-info">
                                ...
                                <span class="portfolio-categories"><?php echo $cats ?></span>
                        </div>
